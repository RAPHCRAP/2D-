...
//
//
//    Vector2f projectToPerspective2D(const Vector3f& point, const camera& cam, float focalLength = 500.0f) {
...
//
//
//    Vector2f projectToScreen2D(const Vector3f& point, const camera& screen)
//    {
//        using namespace MathUtils;
//
...
//    Vector3f up;        
//
//    camera(Vector3f pos = { 0, 0, -500 }, Vector3f lookAt = { 0, 0, 0 }, Vector3f worldUp = { 0, 1, 0 }) 
//    {
//        using namespace MathUtils;
//        position = pos;
...
//
//// ==================== FRAGMENT CLASS ====================
//class Fragmentf : public Drawable {
//public:
//    // Member variables
//    VertexArray shape;
//    bool filled = false;
...
//
//
//bool isInFrontOfCamera(const Polygon3D& poly, const camera& screen)
//{
//    using namespace MathUtils;
//
...
//
//
//    viewWindow(float w, float l, string name)
//    {
//        window = new RenderWindow(VideoMode(w, l), name);
//
//        screen = new camera;
//    }
//
